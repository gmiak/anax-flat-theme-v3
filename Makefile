...
# LESS and CSS
LESS 		 	= style.less layout.less light.less color.less dark.less colorful.less typography1.less fun.less movement.less kontrast.less depth.less computer.less text.less #style1.less #style2.less
...
# target: upgrade-grid    - Upgrade grid.less - grid-flex.less
.PHONY: upgrade-grid
upgrade-grid:
	@$(call HELPTEXT,$@)
	# Responsive-menu
